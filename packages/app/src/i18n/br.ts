export const dict = {
  ...
  "settings.general.row.skin.title": "Aparência",
  "settings.general.row.skin.description": "Aplique decoração da área de trabalho e efeitos de painel independentemente do tema de cores.",
