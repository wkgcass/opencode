export const dict = {
  ...
  "settings.general.row.skin.title": "Оболонка",
  "settings.general.row.skin.description": "Застосовуйте декоративне оформлення й ефекти панелей незалежно від колірної теми.",
