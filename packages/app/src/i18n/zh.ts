...
export const dict = {
  ...
  "prompt.toast.agentSwitchFailed.title": "切换代理失败",
  "prompt.toast.modelSwitchFailed.title": "切换模型失败",
  ...
  "session.messages.workedFor": "已处理{{duration}}",
  "session.messages.workCompleted": "结果如下",
