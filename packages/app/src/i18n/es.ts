export const dict = {
  ...
  "settings.general.row.skin.title": "Apariencia",
  "settings.general.row.skin.description": "Aplica decoración de escritorio y efectos de panel independientemente del tema de color.",
