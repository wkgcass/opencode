  ...
  init: () => {
    ...
    const agent = {
      ...
      set(name: string | undefined) {
        ...
        sdk().api.session
          .switchAgent({ sessionID: session, agent: item.name })
          .catch((err) => {
    ...
    const model = {
      ...
      set(item: ModelKey | undefined, options?: { recent?: boolean }) {
        ...
        sdk().api.session
          .switchModel({ sessionID: session, model: { id: item.modelID, providerID: item.providerID, variant: prevScope?.variant ?? undefined } })
          .catch((err) => {
      ...
      variant: {
        ...
        set(value: string | undefined) {
          ...
          setModelSwitching(true)
          sdk().api.session
            .switchModel({ sessionID: session, model: { id: modelEntry.id, providerID: modelEntry.provider.id, variant: value ?? undefined } })
            .catch((err) => {
