...
import { DesktopNewSessionDesignView } from "@/components/session/desktop-new-session-design-view"
...
function NewSessionContent(props: {
      ...
      <Show when={props.project.selected()}>
        <div class="flex min-h-7 min-w-0 flex-col items-center justify-center gap-0 text-v2-text-text-faint sm:flex-row">
          ...
          <Show
            ...
            fallback={<PromptGitStatus branch={props.workspace.bar.branch()} noGit={!props.workspace.project.git()} />}
          >
  ...
  if (platform.platform === "desktop")
    return (
      <div class="@container relative flex flex-col min-h-0 h-full flex-1">
        <div data-component="session-new-design" class="relative flex-1 min-h-0 overflow-hidden rounded-[10px]">
          <DesktopNewSessionDesignView>
            <NewSessionContent input={props.input} project={props.project} workspace={props.workspace} />
          </DesktopNewSessionDesignView>
          <ProviderTip />
        </div>
      </div>
