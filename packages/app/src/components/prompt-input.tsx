                    ...
                    <Show
                      ...
                      fallback={
                        <Button
                          ...
                          disabled
                          style={control()}
                          class="min-w-0 max-w-[320px] text-text-base"
                        >
                          <Spinner class="size-4" />
                        </Button>
                      }
