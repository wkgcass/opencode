  ...
  return (
    <div ref={sortable.ref} data-sidebar-project-sortable classList={{ "opacity-50": sortable.isDragSource() }}>
      <div class="codex-app-sidebar-project">
        ...
        >
          <Icon
            name={props.local ? "folder" : "cloud"}
            style={props.local ? undefined : { color: serverColor(props.server) }}
          />
...
export function DesktopSidebar() {
  ...
  function DialogDeleteSession(props: { target: DesktopSidebarProject; sessionID: string; title: string }) {
